class Bonus extends GameObject {
    ...
    constructor(image, centreX, centreY, size, moveX, moveY, bonusType, delay = 100)
        {
            ...
            this.NUMBER_OF_COLUMNS_IN_SPRITE_IMAGE = 4; // the number of columns in the gameObject image
            this.NUMBER_OF_ROWS_IN_SPRITE_IMAGE = 2; // the number of rows in the gameObject image	
            this.START_ROW = 0;
            this.START_COLUMN = 0;
